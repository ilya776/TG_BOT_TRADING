...
Supports both Spot and Perpetual Futures trading via CCXT
"""
...
class BybitExecutor(BaseExchange):
    """Bybit exchange executor for spot and futures trading."""
    ...
    async def initialize(self) -> None:
        """Initialize Bybit client via CCXT."""
    ...
    def _ensure_client(self) -> ccxt.bybit:
        """Ensure client is initialized."""
        if not self._client:
            raise RuntimeError("Bybit client not initialized. Call initialize() first.")
        return self._client
    ...
    async def spot_market_buy(
        ...
        try:
            ...
            raise RuntimeError(f"Bybit spot buy failed: {str(e)}") from e
    ...
    async def spot_market_sell(
        ...
        try:
            ...
            raise RuntimeError(f"Bybit spot sell failed: {str(e)}") from e
    ...
    async def spot_limit_buy(
        ...
        try:
            ...
            raise RuntimeError(f"Bybit limit buy failed: {str(e)}") from e
    ...
    async def spot_limit_sell(
        ...
        try:
            ...
            raise RuntimeError(f"Bybit limit sell failed: {str(e)}") from e
    ...
    async def futures_market_long(
        ...
        try:
            ...
            client.options["defaultType"] = "spot"
            raise RuntimeError(f"Bybit futures long failed: {str(e)}") from e
    ...
    async def futures_market_short(
        ...
        try:
            ...
            client.options["defaultType"] = "spot"
            raise RuntimeError(f"Bybit futures short failed: {str(e)}") from e
    ...
    async def futures_close_position(
        ...
        try:
            ...
            client.options["defaultType"] = "spot"
            raise RuntimeError(f"Bybit close position failed: {str(e)}") from e
