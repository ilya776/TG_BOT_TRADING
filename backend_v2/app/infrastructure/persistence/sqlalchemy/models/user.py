...
Maps to users, user_settings, user_api_keys, user_exchange_balances tables.
"""
...
if TYPE_CHECKING:
    ...
    from .whale import UserWhaleFollow
...
class UserExchangeBalance(Base):
    ...
    spot_assets: Mapped[str | None] = mapped_column(Text)
    futures_assets: Mapped[str | None] = mapped_column(Text)
