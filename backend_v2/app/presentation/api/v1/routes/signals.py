...
Real-time whale trading signals listing and copying.
"""
...
class SignalResponse(BaseModel):
    ...
    auto_copy_in: int = 0  # Seconds until auto-copy
...
async def copy_signal(
    ...
    # from app.presentation.workers.tasks.trade_tasks import execute_copy_trade
    # trade_params = {}
    # if body:
    #     if body.size_usdt:
